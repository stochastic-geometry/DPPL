function [link_distance,tr_loc,rec_loc,S_max,maxrate] = funGenerateNetwork(N,diskRadius,N0,alpha)
% Author: Chiranjib Saha and Harpreet S. Dhillion
% 
% This function generates a network with N links and provides the optimal
% subset of active links (E*). 
% Input: N =  number of links, diskRadius = radius of simulation disk
%        N0 = noise power, alpha = pathloss exponent          
% Output: link_distance: NxN matrix of link distances
%         tr_loc :  Nx2 matrix with coordinates of tx locations
%         rec_loc : Nx2 matrix with coordinates of rx locations
%         S_max: 1XN binary array with the active links indicated as `1'
%         maxrate: maximum rate at bps
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 [~,link_distance,tr_loc,rec_loc,~,~] = funSimulateNetworkBinPowerlevel(N,diskRadius,link_dist);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
